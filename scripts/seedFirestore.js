// seedFirestore.js - Script to seed Firestore with user profile and sample data
...
const USER_PROFILE = {
  uid: "iokcMNxr5sdyLrDPnVCEa9e84Gx2",
  email: "joshmaddox0503@gmail.com",
  displayName: "Josh Maddox",
  photoURL: null,
  emailVerified: false,
  stats: {
    shooting: 0,
...
async function seedFirestore() {
  try {
    ...
    console.log('\nYou can now restart your app and sign in.');
