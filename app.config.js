...
export default {
  expo: {
    ...
    plugins: [
      ...
      // Unblocks `pod install`: Firebase's AppCheckCore is a Swift pod and
      // cannot import GoogleUtilities / RecaptchaInterop unless those generate
      // module maps. Must be a plugin — ios/ is regenerated by prebuild.
