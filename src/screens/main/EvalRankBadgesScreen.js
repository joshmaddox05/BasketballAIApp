...
const styles = StyleSheet.create({
  ...
  summaryTitle: { fontSize: 19, fontWeight: '700' },
  summarySub: { fontSize: 14.5, lineHeight: 19, marginTop: 4 },
  card: { borderRadius: 16, borderWidth: 1, padding: 16 },
  cardHeader: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  iconWrap: { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center' },
  cardTitle: { fontSize: 16.5, fontWeight: '700' },
  cardMeaning: { fontSize: 14, lineHeight: 18, marginTop: 2 },
  missing: { fontSize: 13.5, lineHeight: 17.5, marginTop: 10 },
});
