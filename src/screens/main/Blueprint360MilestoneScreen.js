...
const styles = StyleSheet.create({
  ...
  summaryLabel: { color: 'rgba(255,255,255,0.85)', fontSize: 15, marginTop: 4 },
  sectionTitle: { fontSize: 17.5, fontWeight: '700', marginTop: 8 },
  ...
  dueDate: { fontSize: 13 },
  milestoneTitle: { fontSize: 16.5, fontWeight: '600' },
  description: { fontSize: 14, lineHeight: 18, marginTop: 4 },
