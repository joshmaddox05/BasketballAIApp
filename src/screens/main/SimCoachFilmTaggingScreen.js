...
const styles = StyleSheet.create({
  ...
  transportBtn: {},
  transportClock: { fontSize: 15, fontVariant: ['tabular-nums'] },
  tagBtn: {
  ...
  eventTimeText: { fontSize: 14, fontWeight: '700', fontVariant: ['tabular-nums'] },
  eventAction: { fontSize: 16, fontWeight: '700' },
  eventMeta: { fontSize: 14, marginTop: 2 },
  eventDelete: { padding: 4 },

  emptyState: { alignItems: 'center', paddingTop: 40, gap: 10 },
  emptyText: { fontSize: 15, textAlign: 'center', lineHeight: 20, maxWidth: 300 },
