...
const styles = StyleSheet.create({
  ...
  save: { fontSize: 17.5, fontWeight: '700' },
  ...
  helpText: { fontSize: 14, marginTop: -4, marginBottom: 8 },
  input: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontSize: 16.5 },
